...
def actualizarMail():
    ...
    sql = "UPDATE pedidos SET mail='0' WHERE mail='sergei@bullestate.cl' OR mail='jgonzalez@goharvest.cl' OR mail='demianschkolnik@gmail.com' OR mail='carolina@vendetudepto.cl'"
